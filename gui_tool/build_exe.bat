...
echo ============================================
echo  Building Shaft Segmentation Tool EXE
echo ============================================
echo.
...
if exist "dist\ShaftSegmentation.exe" (
    ...
    REM Copy checkpoint to dist folder as backup
    if not exist "dist\checkpoints" mkdir dist\checkpoints
    copy checkpoints\latest.pth dist\checkpoints\

    echo.
    echo The executable includes the model checkpoint.
    echo You can distribute the single .exe file.
) else (
    echo.
